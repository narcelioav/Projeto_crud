...
//Implementando apartir da linha 136, a tag select do HTML, para selecionar os campos no BD
///////////////////////////////////////////////////////////////////////////////////
...
<form method="POST" action="">
    ...
    $query_sniveis_acessos = "SELECT id, nome FROM niveis_acessos ORDER BY nome ASC";
    $result_niveis_acessos = mysqli_query($conn, $query_sniveis_acessos);
    ?>
    ...
    <select name="niveis_acesso_id" id="niveis_acesso_id">
        <option value="">Selecione</option>
        <?php
            while($row_nivei_acesso = mysqli_fetch_assoc($result_niveis_acessos)){
                $select_nivei_acesso = "";
                //se o valor do formulario é igual ao BD
                if(isset($dados['niveis_acesso_id']) and ($dados['niveis_acesso_id'] == $row_nivei_acesso['id'])){
                    $select_nivei_acesso = "selected";
                }elseif(isset($row_usuario['niveis_acesso_id']) and ($row_usuario['niveis_acesso_id'] == $row_nivei_acesso['id'])){
                    //mostra o valor contido no BD
                    //valor pre selecionado
                    $select_nivei_acesso = "selected";
                }

                echo "<option value='" . $row_nivei_acesso['id'] . "' $select_nivei_acesso>" . $row_nivei_acesso['nome'] . "</option>";
            }
        ?>
    </select><br><br>
